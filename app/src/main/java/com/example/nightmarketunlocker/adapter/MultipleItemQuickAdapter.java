package com.example.nightmarketunlocker.adapter;
...
import com.example.nightmarketunlocker.R;
...
public class MultipleItemQuickAdapter extends BaseMultiItemQuickAdapter<MultipleItem, BaseViewHolder> {
    ...
    public MultipleItemQuickAdapter(List data) {
        ...
        addItemType(MultipleItem.TYPE_ORDER_HEADER, R.layout.layout_my_comment_header);
        addItemType(MultipleItem.TYPE_ORDER, R.layout.layout_my_comment);
